...
public class ProductDAO_Collection implements ProductDAO {
    ...
    public ProductDAO_Collection() throws IOException {
        ...
        this.stock.add(new Product(2, "Half-Life", 12.50, 10, "resources\\images\\Half-Life.jpg"));
        this.stock.add(new Product(3, "Half-Life 2", 12.50, 10, "resources\\images\\Half-Life2.jpg"));
    }
